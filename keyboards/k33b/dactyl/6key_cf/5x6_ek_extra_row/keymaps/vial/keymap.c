...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT(
		QK_GESC,KC_1,		KC_2,		KC_3,		KC_4,		KC_5,		KC_X,						KC_X,		KC_6,		KC_7,		KC_8,		KC_9,		KC_0,		KC_BSPC,
		KC_TAB,	KC_Q,		KC_W,		KC_E,		KC_R,		KC_T,		KC_X,						KC_X,		KC_Y,		KC_U,		KC_I,		KC_O,		KC_P,		KC_MINS,
		KC_LSFT,KC_A,		KC_S,		KC_D,		KC_F,		KC_G,		KC_X,						KC_X,		KC_J,		KC_K,		KC_L,		KC_SCLN,KC_QUOT,KC_X,
		KC_LCTL,KC_Z,		KC_X,		KC_C,		KC_V,		KC_B,														KC_N,		KC_M,		KC_COMM,KC_DOT,	KC_SLSH,KC_BSLS,
		KC_X,		KC_X,		KC_LBRC,KC_RBRC,																												KC_RGUI,KC_EQL,	KC_X,		KC_X,
																		RAISE,	KC_SPC,	KC_LGUI,				KC_ENT,	KC_LGUI, LOWER,
																		KC_DEL, KC_HOME,KC_PGUP,				KC_DEL,	KC_BSPC,KC_LALT
	),

	[_RAISE] = LAYOUT(
		KC_F1,	KC_F2,	KC_F3,	KC_F4,	KC_F5,	KC_F6,	_______,				_______,KC_F7,	KC_F8,	KC_F9,	KC_F10,	KC_F11,	KC_F12,
		_______,_______,_______,KC_UP,	_______,KC_LBRC,_______,				_______,KC_RBRC,KC_BTN1,KC_MS_U,KC_BTN2,_______,_______,
		_______,_______,KC_LEFT,KC_DOWN,KC_RGHT,KC_LPRN,_______,				_______,KC_RPRN,KC_MS_L,KC_MS_D,KC_MS_R,_______,_______,
		_______,_______,_______,_______,_______,KC_LABK,												KC_RABK,KC_WH_L,KC_WH_U,KC_WH_R,_______,_______,
		_______,_______,_______,_______,																												_______,KC_WH_D,_______,_______,
																		_______,_______,_______,				_______,_______,_______,
																		_______,_______,_______,				_______,_______,_______
	),

	[_LOWER] = LAYOUT(
		_______,_______,KC_PSCR,KC_SCRL,KC_PAUS,_______,_______,				_______,_______,KC_NUM,	KC_PSLS,KC_PAST,KC_PMNS,_______,
		_______,KC_MUTE,KC_INS,	KC_HOME,KC_PGDN,KC_LBRC,_______,				_______,KC_RBRC,KC_P7,	KC_P8,	KC_P9,	KC_PPLS,_______,
		_______,KC_VOLU,KC_DEL,	KC_END,	KC_PGUP,KC_LPRN,_______,				_______,KC_RPRN,KC_P4,	KC_P5,	KC_P6,	KC_PEQL,_______,
		_______,KC_VOLD,KC_MPRV,KC_MPLY,KC_MNXT,KC_LABK,												KC_RABK,KC_P1,	KC_P2,	KC_P3,	KC_PENT,_______,
		_______,_______,KC_MRWD,KC_MFFD,																												KC_P0,	KC_PDOT,_______,_______,
																		_______,_______,_______,				_______,_______,_______,
																		_______,_______,_______,				_______,_______,_______
	),
	...
	[_CONFIG] = LAYOUT(
		...
		XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,																											XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,
																		_______,XXXXXXX,AU_TOGG,			XXXXXXX,CK_UP,	_______,
																		AU_NEXT,MU_TOGG,MU_NEXT,			CK_TOGG,CK_DOWN,CK_RST
	),
};

const uint8_t music_map[MATRIX_ROWS][MATRIX_COLS] = LAYOUT(
		37,	38,	39,	40,	41,	42, 0,		0, 43,	44,	45,	46,	47,	48,
		25,	26,	27,	28,	29,	30,	0,		0, 31,	32,	33,	34,	35,	36,
		13,	14,	15,	16,	17,	18,	0,		0, 19,	20,	21,	22,	23,	24,
