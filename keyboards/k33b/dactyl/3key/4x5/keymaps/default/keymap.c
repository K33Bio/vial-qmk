...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT(
		...
		KC_Z,		KC_X,		KC_C,		KC_V,		KC_B,																					KC_N,		KC_M,		KC_COMM,KC_DOT,	KC_QUOT,
						QK_GESC,KC_TAB,					RAISE,	SFT_SPC,KC_DEL,				KC_BSPC,CTL_ENT,LOWER,					KC_MINS,KC_EQL
	),
	...
	[_RAISE] = LAYOUT(
		...
		_______,_______,_______,_______,KC_LABK,																			KC_RABK,KC_WH_L,KC_WH_U,KC_WH_R,_______,
	...
	[_CONFIG] = LAYOUT(
		...
		XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,																			CW_TOGG,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,
						MU_TOGG,MU_NEXT,				_______,AU_TOGG,AU_NEXT,			CK_UP,	CK_DOWN,_______,				CK_TOGG,CK_RST
	),
};
