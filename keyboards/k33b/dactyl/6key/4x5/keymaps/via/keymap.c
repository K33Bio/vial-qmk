...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT(
		...
		KC_Z,		KC_X,		KC_C,		KC_V,		KC_B,													KC_N,		KC_M,		KC_COMM,KC_DOT,	KC_QUOT,
						KC_LBRC,KC_RBRC,									`																		KC_MINS,KC_EQL,
														RAISE,	SFT_T(KC_SPC),				CTL_T(KC_ENT),	LOWER,
																		KC_LGUI,KC_DEL,				KC_BSPC,KC_TAB,
																		KC_HOME,QK_GESC,			KC_PGDN,KC_END
	),

	[_RAISE] = LAYOUT(
		_______,_______,KC_UP,	_______,KC_LBRC,											KC_RBRC,KC_BTN1,KC_MS_U,KC_BTN2,_______,
		_______,KC_LEFT,KC_DOWN,KC_RGHT,KC_LPRN,											KC_RPRN,KC_MS_L,KC_MS_D,KC_MS_R,_______,
		_______,_______,KC_SLSH,KC_BSLS,KC_LABK,											KC_RABK,KC_WH_L,KC_WH_U,KC_WH_R,_______,
	...
	[_LOWER] = LAYOUT(
		KC_MUTE,KC_INS,	KC_HOME,KC_PGDN,KC_LBRC,											KC_RBRC,KC_P7,	KC_P8,	KC_P9,	KC_PPLS,
		KC_VOLU,KC_DEL,	KC_END,	KC_PGUP,KC_LPRN,											KC_RPRN,KC_P4,	KC_P5,	KC_P6,	KC_PEQL,
		KC_VOLD,KC_MPRV,KC_MPLY,KC_MNXT,KC_LABK,											KC_RABK,KC_P1,	KC_P2,	KC_P3,	KC_PENT,
						KC_MRWD,KC_MFFD,																											KC_P0,	KC_PDOT,
														_______,_______,											_______,_______,
																		_______,_______,			_______,_______,
																		_______,_______,			_______,_______
	),
	...
	[_CONFIG] = LAYOUT(
		...
		XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,											CW_TOGG,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,
						XXXXXXX,XXXXXXX,																											XXXXXXX,XXXXXXX,
														_______,XXXXXXX,											XXXXXXX,_______,
																		AU_TOGG,AU_NEXT,			CK_UP,	CK_TOGG,
