...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT(
		...
		KC_LSFT,KC_Z,		KC_X,		KC_C,		KC_V,		KC_B,													KC_N,		KC_M,		KC_COMM,KC_DOT,	KC_SLSH,KC_BSLS,
										KC_LBRC,KC_RBRC,																											KC_RGUI,KC_EQL,
																		RAISE,	KC_SPC,												KC_ENT,	LOWER,
																						KC_LGUI,KC_DEL,				KC_BSPC,KC_LALT,
	...
	[_LOWER] = LAYOUT(
		KC_PSCR,KC_MUTE,KC_INS,	KC_HOME,KC_PGDN,KC_LBRC,											KC_RBRC,KC_P7,	KC_P8,	KC_P9,	KC_PPLS,KC_PSLS,
		KC_SCRL,KC_VOLU,KC_DEL,	KC_END,	KC_PGUP,KC_LPRN,											KC_RPRN,KC_P4,	KC_P5,	KC_P6,	KC_PEQL,KC_PAST,
		KC_PAUS,KC_VOLD,KC_MPRV,KC_MPLY,KC_MNXT,KC_LABK,											KC_RABK,KC_P1,	KC_P2,	KC_P3,	KC_PENT,KC_PMNS,
